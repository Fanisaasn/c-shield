...
class AssessmentController extends Controller
{
    ...
    {
        $data = $request->validate(['name'=>['required','string','max:255'],'description'=>['nullable','string'],'order'=>['nullable','integer','min:0']]);
    ...
    private function questionData(Request $request): array { return $request->validate(['assessment_category_id'=>['required','exists:assessment_categories,id'],'question'=>['required','string'],'order'=>['nullable','integer','min:0'],'options'=>['required','array','min:2'],'options.*'=>['required','string','max:255'],'correct_option'=>['required','integer','min:0']]); }
